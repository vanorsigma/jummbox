...
export class TipPrompt {
    constructor(_doc, type) {
        ...
        switch (type) {
            ...
            case "instrumentType":
                {
                    message = div(h2("Instrument Type"), p("JummBox comes with many instrument presets, try them out! You can also create your own custom instruments!"), p("There are also buttons for copying and pasting instruments at the bottom of the instrument settings tab, and for generating random instruments in the \"Randomize\" category in the instrument type menu."));
                }
                break;
            case "eqFilter":
                {
            ...
            case "operatorWaveform":
                {
                    message = div(h2("Operator Waveform"), p('This setting controls the what kind of sound wave an individual FM wave uses. By defualt the FM synth only uses sinewaves.'), p('This feature was ported from Aury system`s GoldBox!'));
                }
                break;
            case "filterType":
                {
